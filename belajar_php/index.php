...
<section id="box-profile">
	<div class="img-profile">
		<div class="photo" style="background-image: url(assets/img/feast.jpg);"></div>
	</div>
	...
	<div class="information">
		...
		<div class="data">
			...
			<p id="pExperience" class="text-gray"><?php echo $expereince; ?></p>
		</div>
		<div class="data">
...
<section id="input-form">
	<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<div class="form">
			...
			<input id="inpAvaibility" type="text" name="avaibility">
		</div>
		<div class="form">
			<label>Age</label>
		...
		<div class="form">
			...
			<input id="inpYears" type="text" name="years">
		</div>
		<div class="form">
			<label>Email</label>
...
<script>
	...
	function editForm(){
		...
		var years = document.getElementById("pExperience").innerHTML;
		var email = document.getElementById("pEmail").innerHTML;

		document.getElementById("inpName").value = name;
		document.getElementById("inpRole").value = role;
		document.getElementById("inpAvaibility").value = available;
